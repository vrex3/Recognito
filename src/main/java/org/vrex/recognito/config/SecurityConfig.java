    ...
    public SecurityFilterChain filterChainStateful(HttpSecurity http) throws Exception {
        ...
        try {
            ...
            http.antMatcher("/client/user/**")
                    ...
                    .antMatchers(HttpMethod.GET, "/client/role/mapping").hasAnyAuthority(RoleUtil.wrapRoles(Role.APP_ADMIN, Role.APP_DEVELOPER))
                    .antMatchers(HttpMethod.POST, "/client/role/mapping").hasAnyAuthority(RoleUtil.wrapRoles(Role.APP_ADMIN))
